...
class FMortalCryPluginWizardDefinition : public IPluginWizardDefinition
{
public:
	FMortalCryPluginWizardDefinition();
...
private:
	/** Creates the templates that are used to create the mod plugin */
