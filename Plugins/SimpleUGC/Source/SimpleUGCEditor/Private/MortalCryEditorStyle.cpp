...
TSharedPtr< FSlateStyleSet > FMortalCryEditorStyle::StyleInstance = NULL;

void FMortalCryEditorStyle::Initialize()
{
...
void FMortalCryEditorStyle::Shutdown()
{
...
FName FMortalCryEditorStyle::GetStyleSetName()
{
...
TSharedRef< FSlateStyleSet > FMortalCryEditorStyle::Create()
{
...
void FMortalCryEditorStyle::ReloadTextures()
{
...
const ISlateStyle& FMortalCryEditorStyle::Get()
{
